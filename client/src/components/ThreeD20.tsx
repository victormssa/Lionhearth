...
import { IcosahedronGeometry, MeshStandardMaterial, DirectionalLight } from 'three';

const ThreeD20: React.FC = () => {
  ...
  return <canvas ref={canvasRef} style={{ width: '100%', height: '100%' }} className='absolute top-0 right-96' />;
};

export default ThreeD20;
